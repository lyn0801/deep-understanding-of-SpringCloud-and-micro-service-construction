package com.lyn0801.security.config;
...
//                .withUser("lyn0801").password("123456").roles("USER");
...
//        manager.createUser(User.withUsername("lyn0801").password("123456").roles("USER").build());
